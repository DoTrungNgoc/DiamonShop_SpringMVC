		...
		<div class="span4">
			...
			<form:form action="dang-ky" modelAttribute="user" method="post">
			  ...
			  <div class="control-group">
				...
				<div class="controls">
				  <form:input path="password" class="span3"  type="password" placeholder="Mời nhập mật khẩu" />
				</div>
			  </div>
			  <div class="control-group">
				<label class="control-label" for="inputEmail">Họ và tên</label>
				<div class="controls">
				  <form:input path="display_name" class="span3"  type="text" placeholder="Mời nhập họ và tên"/>
				</div>
			  </div>
			  <div class="control-group">
				<label class="control-label" for="inputEmail">Địa chỉ</label>
				<div class="controls">
				  <form:input path="address" class="span3"  type="text" placeholder="Mời nhập địa chỉ" />
				</div>
			  </div>
		...
		<div class="span4">
			...
			<form:form action="dang-nhap" modelAttribute="user" method="post">
			  <div class="control-group">
				...
				<div class="controls">
				  <form:input path="user" class="span3"  type="text" placeholder="Mời nhập email" />
				</div>
			  </div>
			  <div class="control-group">
				<label class="control-label" for="inputPassword">Password</label>
				<div class="controls">
				  <form:input path="password" type="password" class="span3" placeholder="Mời nhập password" />
				</div>
			  </div>
			  <div class="control-group">
				<div class="controls">
