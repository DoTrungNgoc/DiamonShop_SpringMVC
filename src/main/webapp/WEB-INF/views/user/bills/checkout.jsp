	...
	<div class="row">
		...
		<div class="span9">
			...
			<div class="row">
				<div class="span8">
					<div class="well">
						<form:form action="checkout" modelAttribute="bills" method="post" class="form-horizontal">
							<h3>Thanh toán đơn hàng</h3>
							<div class="control-group">
								<label class="control-label">Họ tên <sup>*</sup></label>
								<div class="controls">
									<form:input path="display_name" type="text" placeholder=" Mời nhập họ tên" />
								</div>
							</div>
							<div class="control-group">
								<label class="control-label">Email <sup>*</sup></label>
								<div class="controls">
									<form:input path="user" type="text" placeholder=" Mời nhập Email" />
								</div>
							</div>
							<div class="control-group">
							...
							<div class="control-group">
								...
								<div class="controls">
									<form:textarea path="note" rows="5"></form:textarea>
								</div>
							</div>
							<div class="control-group">
								<div class="controls">
